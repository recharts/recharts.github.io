import{R as t}from"./iframe-CZrGjRVd.js";import{g as p}from"./utils-ePvtT4un.js";import{S as s}from"./ScatterChartArgs-DVckGNEz.js";import{a as d}from"./Coordinate-geWwP0Ct.js";import{S as m}from"./ScatterChart-DSU2kMg5.js";import{R as g}from"./zIndexSlice-DVGip-HY.js";import{X as S}from"./XAxis-CseioX8F.js";import{Y as l}from"./YAxis-DvRRjJMV.js";import{S as f}from"./Scatter-DP8MA9dk.js";const h={argTypes:s,component:m},e={name:"Simple",render:n=>{const{data:i,...c}=n;return t.createElement(g,{width:"100%",height:400},t.createElement(m,{...c},t.createElement(S,{dataKey:"x"}),t.createElement(l,{dataKey:"y"}),t.createElement(f,{data:i})))},args:{...p(s),data:d,margin:{top:0,right:0,bottom:0,left:0}}};var r,a,o;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
    const {
      data,

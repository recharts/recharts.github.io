...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},Pt={argTypes:W,component:C},T={name:"Simple",render:e=>x.createElement(z,{width:"100%",height:400},x.createElement(C,{data:A,...e},x.createElement(ze,null))),args:{...F(W),data:A}},j={render:e=>x.createElement(z,{width:"100%",height:400},x.createElement(C,{data:A,...e})),args:{...F(W),data:A,nodeWidth:10,nodePadding:60,height:500,width:960}},I={render:e=>{const n=["#3C898E","#486DF0","#6F50E5"],o=t=>x.createElement("rect",{x:t.x+4,y:t.y-2,width:t.width-8,height:t.height+4,fill:n[t.payload.depth%n.length],rx:2.5}),s=t=>x.createElement("g",null,x.createElement("path",{d:`
  M${t.sourceX},${t.sourceY}
  C${t.sourceControlX},${t.sourceY} ${t.targetControlX},${t.targetY} ${t.targetX},${t.targetY}`,fill:"none",stroke:n[t.payload.source.depth%n.length],strokeOpacity:.4,strokeWidth:t.linkWidth,strokeLinecap:"butt"}),x.createElement("foreignObject",{x:t.sourceX,y:t.targetY-t.linkWidth/2,width:Math.max(t.targetX,t.sourceX)-Math.min(t.targetX,t.sourceX),height:t.linkWidth,style:{overflow:"visible"}},x.createElement("div",{style:{boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"flex-end",width:"100%",height:"100%",overflow:"visible",padding:"0.5em",gap:8}},x.createElement("div",{style:{fontSize:10,fontFamily:"sans-serif",textAlign:"center",backgroundColor:"#f1f5fe80",padding:"0.25em 0.5em",borderRadius:4,position:"relative",zIndex:1}},t.payload.target.name?`${t.payload.target.name}: `:"",t.payload.value," €"))));return x.createElement(z,{width:"100%",height:400},x.createElement(C,{data:oe,node:o,link:s,...e}))},args:{...F(W),data:oe,nodeWidth:16,nodePadding:14,height:500,width:960,sort:!1,margin:{top:20,left:20,right:20,bottom:20}}};var se,ie,le;T.parameters={...T.parameters,docs:{...(se=T.parameters)==null?void 0:se.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {

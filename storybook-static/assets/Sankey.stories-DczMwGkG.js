...
Can be a number or a percent string like "100%".`,table:{type:{summary:"number | string"},category:"General"}}},Ct={argTypes:$,component:E},N={name:"Simple",render:e=>g.createElement(G,{width:"100%",height:400},g.createElement(E,{data:V,...e},g.createElement(qe,null),g.createElement(K,null))),args:{...q($),data:V}},T={render:e=>g.createElement(G,{width:"100%",height:400},g.createElement(E,{data:V,...e},g.createElement(K,null))),args:{...q($),data:V,nodeWidth:10,nodePadding:60,height:500,width:960}},R={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],i=n=>g.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),o=n=>g.createElement("g",null,g.createElement("path",{d:`
  M${n.sourceX},${n.sourceY}
  C${n.sourceControlX},${n.sourceY} ${n.targetControlX},${n.targetY} ${n.targetX},${n.targetY}`,fill:"none",stroke:t[n.payload.source.depth%t.length],strokeOpacity:.4,strokeWidth:n.linkWidth,strokeLinecap:"butt"}),g.createElement("foreignObject",{x:n.sourceX,y:n.targetY-n.linkWidth/2,width:Math.max(n.targetX,n.sourceX)-Math.min(n.targetX,n.sourceX),height:n.linkWidth,style:{overflow:"visible"}},g.createElement("div",{style:{boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"flex-end",width:"100%",height:"100%",overflow:"visible",padding:"0.5em",gap:8}},g.createElement("div",{style:{fontSize:10,fontFamily:"sans-serif",textAlign:"center",backgroundColor:"#f1f5fe80",padding:"0.25em 0.5em",borderRadius:4,position:"relative",zIndex:1}},n.payload.target.name?`${n.payload.target.name}: `:"",n.payload.value," €"))));return g.createElement(G,{width:"100%",height:400},g.createElement(E,{data:oe,node:i,link:o,...e},g.createElement(K,null)))},args:{...q($),data:oe,nodeWidth:16,nodePadding:14,height:500,width:960,sort:!1,margin:{top:20,left:20,right:20,bottom:20}}};var re,se,ie;N.parameters={...N.parameters,docs:{...(re=N.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {

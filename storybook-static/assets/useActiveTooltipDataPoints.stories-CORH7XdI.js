import{a as e}from"./iframe-CNkb7Pxq.js";import{P as o}from"./_data-CE1j0ret.js";import{g as d}from"./utils-ePvtT4un.js";import{T as i}from"./TooltipArgs-TAq2cD4k.js";import{T as p}from"./Tooltip-1bb6gcko.js";import{R as l}from"./zIndexSlice-wl2-d2L7.js";import{C as c}from"./ComposedChart-C_D-eBru.js";import{p as g}from"./Page-Cj8EiXz7.js";import{A as r}from"./Area-CdP97sQO.js";import{L as A}from"./Line-gVhmKqSC.js";import{X as v}from"./XAxis-Cy627mpO.js";import{Y as u}from"./YAxis-Bv4i31q_.js";import{L as f}from"./Legend-DTeqwQyH.js";const y={argTypes:i,title:"API/hooks/useActiveTooltipDataPoints",component:p},T=o.map(a=>({name:a.name,uv:a.uv})),C=o.map(a=>({name:a.name,pv:a.pv})),P=o.map(a=>({name:a.name,amt:a.amt})),t={name:"useActiveTooltipDataPoints",render:a=>e.createElement(l,{width:"100%",height:400},e.createElement(c,{data:g},e.createElement(r,{data:C,dataKey:"pv"}),e.createElement(r,{data:T,dataKey:"uv"}),e.createElement(A,{data:P,dataKey:"amt"}),e.createElement(v,{dataKey:"name",allowDuplicatedCategory:!1}),e.createElement(u,null),e.createElement(f,null),e.createElement(p,{...a}))),args:d(i)},D=["UseActiveTooltipDataPoints"];var s,n,m;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{

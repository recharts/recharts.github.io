...
@defaultValue false`,name:"breakAll",required:!1,type:{name:"boolean"}}}}}catch{}try{R.displayName="Text",R.__docgenInfo={description:"",displayName:"Text",props:{textAnchor:{defaultValue:null,description:`Horizontal text alignment within the text element.
...
**Note:** Only effective when \`width\` is defined to enable line breaking.
@defaultValue false`,name:"breakAll",required:!1,type:{name:"boolean"}}}}}catch{}export{R as T,U as i};

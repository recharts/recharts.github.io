...
- Ignored when \`textPath\` is set because path text is rendered directly without truncation`,name:"maxLines",parent:{fileName:"recharts/src/component/Text.tsx",name:"TextProps"},required:!1,tags:{},type:{name:"number"}}},tags:{}}}catch{}try{$.displayName="Text",$.__docgenInfo={description:"",displayName:"Text",filePath:"/home/runner/work/recharts/recharts/src/component/Text.tsx",methods:[],props:{textAnchor:{defaultValue:null,declarations:[{fileName:"recharts/src/component/Text.tsx",name:"TextProps"}],description:`Horizontal text alignment within the text element.
...
Ignored when \`textPath\` is set because the text is rendered along a single path.`,name:"lineHeight",parent:{fileName:"recharts/src/component/Text.tsx",name:"TextProps"},required:!1,tags:{defaultValue:"'1em'"},type:{name:"string | number"}},textPath:{defaultValue:null,declarations:[{fileName:"recharts/src/component/Text.tsx",name:"TextProps"}],description:"When set, renders the text along the SVG path described by this `d` attribute.\nIn path mode, `breakAll`, `lineHeight`, `maxLines`, and `verticalAnchor` are ignored.",name:"textPath",parent:{fileName:"recharts/src/component/Text.tsx",name:"TextProps"},required:!1,tags:{since:"3.11"},type:{name:"string"}}},tags:{}}}catch{}export{$ as T,Z as a,D as i};

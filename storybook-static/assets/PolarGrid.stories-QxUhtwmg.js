import{R as r}from"./iframe-pl42v7Eu.js";import{g as c}from"./utils-ePvtT4un.js";import{P as i}from"./PolarGrid-WPJYThj1.js";import{S as u}from"./isWellBehavedNumber-B6cHM4DS.js";const l={angleAxisId:{table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"0"}},defaultValue:0},cx:{description:`The x-coordinate of center.
...
If undefined or 0, the content is rendered in the default layer without portals.`,control:{type:"number"},table:{type:{summary:"number"},category:"General",defaultValue:{summary:"-100"}},defaultValue:-100}},y={argTypes:l,component:i},[t,a]=[500,500],e={name:"Simple",render:d=>r.createElement(u,{width:t,height:a,viewBox:{x:0,y:0,width:t,height:a}},r.createElement(i,{cx:250,cy:250,innerRadius:0,outerRadius:200,...d})),args:{...c(l),polarAngles:[0,30,60,90,145,180,200,270,300],polarRadius:[10,20,40,80],stroke:"#ccc",strokeWidth:1,fill:"none",fillOpacity:.2}};var n,o,s;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(s=(o=e.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const p=["API"],b=Object.freeze(Object.defineProperty({__proto__:null,API:e,__namedExportsOrder:p,default:y},Symbol.toStringTag,{value:"Module"}));export{e as A,b as C};

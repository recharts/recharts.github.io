import{R as t}from"./iframe-DGZg1BaY.js";import{g as p}from"./utils-ePvtT4un.js";import{S as s}from"./ScatterChartArgs-DVckGNEz.js";import{a as d}from"./Coordinate-geWwP0Ct.js";import{S as m}from"./ScatterChart-r1LHitse.js";import{R as g}from"./zIndexSlice-RSobkBfJ.js";import{X as S}from"./XAxis-BkrEDfGE.js";import{Y as l}from"./YAxis-BZtV9zAx.js";import{S as f}from"./Scatter-D3q9zRD3.js";const h={argTypes:s,component:m},e={name:"Simple",render:n=>{const{data:i,...c}=n;return t.createElement(g,{width:"100%",height:400},t.createElement(m,{...c},t.createElement(S,{dataKey:"x"}),t.createElement(l,{dataKey:"y"}),t.createElement(f,{data:i})))},args:{...p(s),data:d,margin:{top:0,right:0,bottom:0,left:0}}};var r,a,o;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
    const {
      data,

...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},I={argTypes:u,component:c},r={name:"Simple",render:t=>{const{data:i,activeShape:s}=t;return e.createElement(P,{width:"100%",height:400},e.createElement(c,{...t},e.createElement(p,{data:i,dataKey:"uv",shape:({isActive:m,...l})=>e.createElement(F,{...l,fill:m?s.fill:l.fill})}),e.createElement(A,{defaultIndex:3}),e.createElement(g,null)))},args:{...y(u),data:k,activeShape:{fill:"red"},margin:{top:0,right:0,bottom:0,left:0}}},n={render:t=>e.createElement(c,{...t},e.createElement(p,{data:t.data,dataKey:"uv",nameKey:"name",innerRadius:50,outerRadius:80,cornerRadius:8},e.createElement(E,{position:"center",fill:"#000",fontSize:12,fontWeight:"bold",dy:-7},"Donut"),e.createElement(E,{position:"center",fontSize:12,fontWeight:"bold",dy:8},"Chart"),e.createElement(M,{align:"right",verticalAlign:"middle",layout:"vertical"})),e.createElement(g,null)),args:{...y(u),width:500,height:300,data:k}},o={render:t=>{const i=[{x:{value:1},name:"x1",fill:"blue"},{x:{value:2},name:"x2",fill:"red"},{x:{value:3},name:"x3",fill:"green"}],s=[{y:{value:3},name:"y1",fill:"blue"},{y:{value:2},name:"y2",fill:"red"},{y:{value:1},name:"y3",fill:"green"}],m=a=>(v(a.x),a.x.value),l=a=>(v(a.y),a.y.value),[d,b]=f.useState(!1),[z,h]=f.useState(!0);return e.createElement(e.Fragment,null,e.createElement("button",{type:"button",onClick:()=>{b(!1),h(!0)}},"Use data1"),e.createElement("button",{type:"button",onClick:()=>{b(!0),h(!0)}},"Use data2"),e.createElement("button",{type:"button",onClick:()=>{h(!1)}},"Hide"),e.createElement(c,{...t,data:d?s:i},e.createElement(A,null),e.createElement(M,null),e.createElement(g,null),e.createElement(p,{data:d?s:i,name:"Animated line",hide:!z,type:"monotone",dataKey:d?l:m,stroke:"#8884d8",strokeDasharray:"5 5",label:{fill:"red"},animationDuration:3e3})))},args:{...y(u),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}};var C,G,S;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(S=(G=r.parameters)==null?void 0:G.docs)==null?void 0:S.source}}};var x,V,T;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
...
}`,...(T=(V=n.parameters)==null?void 0:V.docs)==null?void 0:T.source}}};var w,R,D;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
    type MockDataType = {
      x?: {
        value: number;
...
}`,...(D=(R=o.parameters)==null?void 0:R.docs)==null?void 0:D.source}}};const K=["API","Donut","ChangingDataKey"],X=Object.freeze(Object.defineProperty({__proto__:null,API:r,ChangingDataKey:o,Donut:n,__namedExportsOrder:K,default:I},Symbol.toStringTag,{value:"Module"}));export{r as A,X as C};

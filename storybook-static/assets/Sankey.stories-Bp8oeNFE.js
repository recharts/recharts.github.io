import{g as Ee,r as m,R as k}from"./iframe-Clh6Am28.js";import{g as O}from"./utils-ePvtT4un.js";import{m as Ne}from"./maxBy-DcDU2zJt.js";import{r as Ce}from"./iteratee-CWb0-VE6.js";import{g as Pe}from"./get-ReXw4Xs6.js";import{i as ee,S as we}from"./isWellBehavedNumber-BTdz8jY9.js";import{L as R}from"./Layer-rOqvObKk.js";import{R as Le}from"./Rectangle-CZG00UlM.js";import{V as Te,W as Ve,u as Me,a as je,q as w,f as me,R as Y}from"./zIndexSlice-C8WH1sbl.js";import{R as Ie,d as De,a0 as Re,$ as $e,i as Ae,P as ye,O as pe,N as fe}from"./RechartsWrapper-kLRmp8Nc.js";import{R as We,S as qe}from"./RegisterGraphicalItemId-C0MecWm_.js";import{S as Ge}from"./chartDataContext-BpoRQBsX.js";import{r as Xe,n as Fe,s as z,q as Oe,b as ge}from"./resolveDefaultProps-Cp4jCd2q.js";import{T as Ye}from"./Tooltip-DcVhVaK_.js";var G={},te;function ze(){if(te)return G;te=1;const e=Ce();function t(s,r){if(!s||!s.length)return 0;r!=null&&(r=e.iteratee(r));let n;for(let i=0;i<s.length;i++){const a=r?r(s[i]):s[i];a!==void 0&&(n===void 0?n=a:n+=a)}return n}return G.sumBy=t,G}var X,ne;function _e(){return ne||(ne=1,X=ze().sumBy),X}var Be=_e();const Ke=Ee(Be),Ue=(e,t)=>{const s=+e,r=t-s;return n=>s+r*n},P=e=>e.y+e.dy/2,M=e=>e&&e.value||0,I=(e,t)=>t.reduce((s,r)=>s+M(e[r]),0),He=(e,t,s)=>s.reduce((r,n)=>{const i=t[n];if(i==null)return r;const a=e[i.source];return a==null?r:r+P(a)*M(t[n])},0),Je=(e,t,s)=>s.reduce((r,n)=>{const i=t[n];if(i==null)return r;const a=e[i.target];return a==null?r:r+P(a)*M(t[n])},0),Qe=(e,t)=>e.y-t.y,Ze=(e,t)=>{const s=[],r=[],n=[],i=[];for(let a=0,u=e.length;a<u;a++){const o=e[a];(o==null?void 0:o.source)===t&&(n.push(o.target),i.push(a)),(o==null?void 0:o.target)===t&&(s.push(o.source),r.push(a))}return{sourceNodes:s,sourceLinks:r,targetLinks:i,targetNodes:n}},ke=(e,t)=>{const{targetNodes:s}=t;for(let r=0,n=s.length;r<n;r++){const i=s[r];if(i==null)continue;const a=e[i];a&&(a.depth=Math.max(t.depth+1,a.depth),ke(e,a))}},et=({nodes:e,links:t},s,r,n)=>{var u;const i=e.map((o,c)=>{const l=Ze(t,c);return{...o,...l,value:Math.max(I(t,l.sourceLinks),I(t,l.targetLinks)),depth:0}});for(let o=0,c=i.length;o<c;o++){const l=i[o];l!=null&&!l.sourceNodes.length&&ke(i,l)}const a=((u=Ne(i,o=>o.depth))==null?void 0:u.depth)??0;if(a>=1){const o=(s-r)/a;for(let c=0,l=i.length;c<l;c++){const d=i[c];d!=null&&(d.targetNodes.length||n==="justify"&&(d.depth=a),d.x=d.depth*o,d.dx=r)}}return{tree:i,maxDepth:a}},tt=e=>{var s;const t=[];for(let r=0,n=e.length;r<n;r++){const i=e[r];i!=null&&(t[i.depth]||(t[i.depth]=[]),(s=t[i.depth])==null||s.push(i))}return t},nt=(e,t,s,r,n)=>{let i=Math.min(...e.map(a=>{const u=Ke(a,M);return u===0?1/0:(t-(a.length-1)*s)/u}));i===1/0&&(i=0);for(let a=0,u=e.length;a<u;a++){const o=e[a];if(o!=null)if(n==="top"){let c=0;for(let l=0,d=o.length;l<d;l++){const h=o[l];h!=null&&(h.dy=h.value*i,h.y=c,c+=h.dy+s)}}else for(let c=0,l=o.length;c<l;c++){const d=o[c];d!=null&&(d.y=c,d.dy=d.value*i)}}return r.map(a=>({...a,dy:M(a)*i}))},F=(e,t,s,r=!0)=>{for(let n=0,i=e.length;n<i;n++){const a=e[n];if(a==null)continue;const u=a.length;r&&a.sort(Qe);let o=0;for(let c=0;c<u;c++){const l=a[c];if(l==null)continue;const d=o-l.y;d>0&&(l.y+=d),o=l.y+l.dy+s}o=t+s;for(let c=u-1;c>=0;c--){const l=a[c];if(l==null)continue;const d=l.y+l.dy+s-o;if(d>0)l.y-=d,o=l.y;else break}}},at=(e,t,s,r)=>{for(let n=0,i=t.length;n<i;n++){const a=t[n];if(a!=null)for(let u=0,o=a.length;u<o;u++){const c=a[u];if(c!=null&&c.sourceLinks.length){const l=I(s,c.sourceLinks),d=He(e,s,c.sourceLinks),h=l===0?P(c):d/l;c.y+=(h-P(c))*r}}}},rt=(e,t,s,r)=>{for(let n=t.length-1;n>=0;n--){const i=t[n];if(i!=null)for(let a=0,u=i.length;a<u;a++){const o=i[a];if(o!=null&&o.targetLinks.length){const c=I(s,o.targetLinks),l=Je(e,s,o.targetLinks),d=c===0?P(o):l/c;o.y+=(d-P(o))*r}}}},ot=(e,t)=>{for(let s=0,r=e.length;s<r;s++){const n=e[s];if(n==null)continue;let i=0,a=0;n.targetLinks.sort((u,o)=>{var v,f,g,b;const c=(v=t[u])==null?void 0:v.target,l=(f=t[o])==null?void 0:f.target;if(c==null||l==null)return 0;const d=(g=e[c])==null?void 0:g.y,h=(b=e[l])==null?void 0:b.y;return d==null||h==null?0:d-h}),n.sourceLinks.sort((u,o)=>{var v,f,g,b;const c=(v=t[u])==null?void 0:v.source,l=(f=t[o])==null?void 0:f.source;if(c==null||l==null)return 0;const d=(g=e[c])==null?void 0:g.y,h=(b=e[l])==null?void 0:b.y;return d==null||h==null?0:d-h});for(let u=0,o=n.targetLinks.length;u<o;u++){const c=n.targetLinks[u];if(c==null)continue;const l=t[c];l&&(l.sy=i,i+=l.dy)}for(let u=0,o=n.sourceLinks.length;u<o;u++){const c=n.sourceLinks[u];if(c==null)continue;const l=t[c];l&&(l.ty=a,a+=l.dy)}}},st=({data:e,width:t,height:s,iterations:r,nodeWidth:n,nodePadding:i,sort:a,verticalAlign:u,align:o})=>{const{links:c}=e,{tree:l}=et(e,t,n,o),d=tt(l),h=nt(d,s,i,c,u);if(F(d,s,i,a),u==="justify"){let f=1;for(let g=1;g<=r;g++)rt(l,d,h,f*=.99),F(d,s,i,a),at(l,d,h,f),F(d,s,i,a)}return ot(l,h),{nodes:l,links:h}},it=e=>({x:+e.x+ +e.width/2,y:+e.y+ +e.height/2}),lt=e=>"sourceX"in e?{x:(e.sourceX+e.targetX)/2,y:(e.sourceY+e.targetY)/2}:void 0,ct=(e,t,s)=>{const{payload:r}=e;if(t==="node")return{payload:r,name:w(r,s,""),value:w(r,"value")};if("source"in r&&r.source&&r.target){const n=w(r.source,s,""),i=w(r.target,s,"");return{payload:r,name:`${n} - ${i}`,value:w(r,"value")}}},ut=(e,t,s,r)=>{if(t==null||typeof t!="string"||s==null||typeof s!="object")return;const n=t.split("-"),[i,a]=n,u=Pe(s,`${i}s[${a}]`);if(u)return ct(u,i,r)},dt={chartName:"Sankey",defaultTooltipEventType:"item",validateTooltipEventTypes:["item"],tooltipPayloadSearcher:ut,eventEmitter:void 0},ht=m.memo(({dataKey:e,nameKey:t,stroke:s,strokeWidth:r,fill:n,name:i,data:a,id:u})=>{const o={dataDefinedOnItem:a,getPosition:Fe,settings:{stroke:s,strokeWidth:r,fill:n,dataKey:e,name:i,nameKey:t,hide:!1,type:void 0,color:n,unit:"",graphicalItemId:u}};return m.createElement(qe,{tooltipEntrySettings:o})});function mt(e,t){if(m.isValidElement(e))return m.cloneElement(e,t);if(typeof e=="function")return e(t);const{sourceX:s,sourceY:r,sourceControlX:n,targetX:i,targetY:a,targetControlX:u,linkWidth:o,...c}=t;return m.createElement("path",{className:"recharts-sankey-link",d:`
          M${s},${r}
          C${n},${r} ${u},${a} ${i},${a}
        `,fill:"none",stroke:"#333",strokeWidth:o,strokeOpacity:"0.2",...z(c)})}const yt=({link:e,nodes:t,left:s,top:r,i:n,linkContent:i,linkCurvature:a})=>{const{sy:u,ty:o,dy:c}=e,l=t[e.source],d=t[e.target];if(l==null||d==null)return;const h=l.x+l.dx+s,v=d.x+s,f=Ue(h,v),g=f(a),b=f(1-a),j=l.y+u+c/2+r,x=d.y+o+c/2+r;return{sourceX:h,targetX:v,sourceY:j,targetY:x,sourceControlX:g,targetControlX:b,sourceRelativeY:u,targetRelativeY:o,linkWidth:c,index:n,payload:{...e,source:l,target:d},...ge(i)}};function pt({graphicalItemId:e,props:t,i:s,linkContent:r,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:u}){const o=lt(t),c=`link-${s}`,l=me(),d={onMouseEnter:h=>{l(fe({activeIndex:c,activeDataKey:u,activeCoordinate:o,activeGraphicalItemId:e})),n(t,h)},onMouseLeave:h=>{l(pe()),i(t,h)},onClick:h=>{l(ye({activeIndex:c,activeDataKey:u,activeCoordinate:o,activeGraphicalItemId:e})),a(t,h)}};return m.createElement(R,{...d},mt(r,t))}function ft({graphicalItemId:e,modifiedLinks:t,links:s,linkContent:r,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:u}){return m.createElement(R,{className:"recharts-sankey-links",key:"recharts-sankey-links"},s.map((o,c)=>{const l=t[c];return l==null?null:m.createElement(pt,{graphicalItemId:e,key:`link-${o.source}-${o.target}-${o.value}`,props:l,linkContent:r,i:c,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:u})}))}function gt(e,t){return m.isValidElement(e)?m.cloneElement(e,t):typeof e=="function"?e(t):m.createElement(Le,{className:"recharts-sankey-node",fill:"#0088fe",fillOpacity:"0.8",...z(t)})}const kt=({node:e,nodeContent:t,top:s,left:r,i:n})=>{const{x:i,y:a,dx:u,dy:o}=e;return{...ge(t),x:i+r,y:a+s,width:u,height:o,index:n,payload:e}};function vt({graphicalItemId:e,props:t,nodeContent:s,i:r,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:u}){const o=me(),c=it(t),l=`node-${r}`,d={onMouseEnter:h=>{o(fe({activeIndex:l,activeDataKey:u,activeCoordinate:c,activeGraphicalItemId:e})),n(t,h)},onMouseLeave:h=>{o(pe()),i(t,h)},onClick:h=>{o(ye({activeIndex:l,activeDataKey:u,activeCoordinate:c,activeGraphicalItemId:e})),a(t,h)}};return m.createElement(R,{...d},gt(s,t))}function St({graphicalItemId:e,modifiedNodes:t,nodeContent:s,onMouseEnter:r,onMouseLeave:n,onClick:i,dataKey:a}){return m.createElement(R,{className:"recharts-sankey-nodes",key:"recharts-sankey-nodes"},t.map((u,o)=>m.createElement(vt,{graphicalItemId:e,key:`node-${u.index}-${u.x}-${u.y}`,props:u,nodeContent:s,i:o,onMouseEnter:r,onMouseLeave:n,onClick:i,dataKey:a})))}const bt={align:"justify",dataKey:"value",iterations:32,linkCurvature:.5,margin:{top:5,right:5,bottom:5,left:5},nameKey:"name",nodePadding:10,nodeWidth:10,sort:!0,verticalAlign:"justify",...Ae};function xt(e){const{className:t,style:s,children:r,id:n,...i}=e,{link:a,dataKey:u,node:o,onMouseEnter:c,onMouseLeave:l,onClick:d,data:h,iterations:v,nodeWidth:f,nodePadding:g,sort:b,linkCurvature:j,margin:x,verticalAlign:A,align:_}=e,ve=z(i),N=Me(),C=je(),{links:Se,modifiedLinks:B,modifiedNodes:K}=m.useMemo(()=>{if(!h||!N||!C||N<=0||C<=0)return{nodes:[],links:[],modifiedLinks:[],modifiedNodes:[]};const y=N-(x.left??0)-(x.right??0),p=C-(x.top??0)-(x.bottom??0),S=st({data:h,width:y,height:p,iterations:v,nodeWidth:f,nodePadding:g,sort:b,verticalAlign:A,align:_}),Q=x.top||0,Z=x.left||0,be=S.links.map((W,q)=>yt({link:W,nodes:S.nodes,i:q,top:Q,left:Z,linkContent:a,linkCurvature:j})).filter(Oe),xe=S.nodes.map((W,q)=>kt({node:W,nodeContent:o,i:q,top:Q,left:Z}));return{nodes:S.nodes,links:S.links,modifiedLinks:be,modifiedNodes:xe}},[h,N,C,x,v,f,g,b,a,o,j,_,A]),U=m.useCallback((y,p,S)=>{c&&c(y,p,S)},[c]),H=m.useCallback((y,p,S)=>{l&&l(y,p,S)},[l]),J=m.useCallback((y,p,S)=>{d&&d(y,p,S)},[d]);return!ee(N)||!ee(C)||!h||!h.links||!h.nodes?null:m.createElement(m.Fragment,null,m.createElement(Ge,{computedData:{links:B,nodes:K}}),m.createElement(we,{...ve,width:N,height:C},r,m.createElement(ft,{graphicalItemId:n,links:Se,modifiedLinks:B,linkContent:a,dataKey:u,onMouseEnter:(y,p)=>U(y,"link",p),onMouseLeave:(y,p)=>H(y,"link",p),onClick:(y,p)=>J(y,"link",p)}),m.createElement(St,{graphicalItemId:n,modifiedNodes:K,nodeContent:o,dataKey:u,onMouseEnter:(y,p)=>U(y,"node",p),onMouseLeave:(y,p)=>H(y,"node",p),onClick:(y,p)=>J(y,"node",p)})))}function E(e){const t=Xe(e,bt),{width:s,height:r,style:n,className:i,id:a,throttleDelay:u,throttledEvents:o}=t,[c,l]=m.useState(null);return m.createElement(Ie,{preloadedState:{options:dt},reduxStoreName:i??"Sankey"},m.createElement(Te,{width:s,height:r}),m.createElement(Ve,{margin:t.margin}),m.createElement(De,{throttleDelay:u,throttledEvents:o}),m.createElement(Re,{className:i,style:n,width:s,height:r,responsive:!1,ref:d=>{d&&!c&&l(d)},onMouseEnter:void 0,onMouseLeave:void 0,onClick:void 0,onMouseMove:void 0,onMouseDown:void 0,onMouseUp:void 0,onContextMenu:void 0,onDoubleClick:void 0,onTouchStart:void 0,onTouchMove:void 0,onTouchEnd:void 0},m.createElement($e.Provider,{value:c},m.createElement(We,{id:a,type:"sankey"},d=>m.createElement(m.Fragment,null,m.createElement(ht,{dataKey:t.dataKey,nameKey:t.nameKey,stroke:t.stroke,strokeWidth:t.strokeWidth,fill:t.fill,name:t.name,data:t.data,id:d}),m.createElement(xt,{...t,id:d}))))))}E.displayName="Sankey";try{E.displayName="Sankey",E.__docgenInfo={description:`Flow diagram in which the width of the arrows is proportional to the flow rate.
...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},Et={argTypes:$,component:E},L={name:"Simple",render:e=>k.createElement(Y,{width:"100%",height:400},k.createElement(E,{data:D,...e},k.createElement(Ye,null))),args:{...O($),data:D}},T={render:e=>k.createElement(Y,{width:"100%",height:400},k.createElement(E,{data:D,...e})),args:{...O($),data:D,nodeWidth:10,nodePadding:60,height:500,width:960}},V={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],s=n=>k.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),r=n=>k.createElement("g",null,k.createElement("path",{d:`
  M${n.sourceX},${n.sourceY}
  C${n.sourceControlX},${n.sourceY} ${n.targetControlX},${n.targetY} ${n.targetX},${n.targetY}`,fill:"none",stroke:t[n.payload.source.depth%t.length],strokeOpacity:.4,strokeWidth:n.linkWidth,strokeLinecap:"butt"}),k.createElement("foreignObject",{x:n.sourceX,y:n.targetY-n.linkWidth/2,width:Math.max(n.targetX,n.sourceX)-Math.min(n.targetX,n.sourceX),height:n.linkWidth,style:{overflow:"visible"}},k.createElement("div",{style:{boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"flex-end",width:"100%",height:"100%",overflow:"visible",padding:"0.5em",gap:8}},k.createElement("div",{style:{fontSize:10,fontFamily:"sans-serif",textAlign:"center",backgroundColor:"#f1f5fe80",padding:"0.25em 0.5em",borderRadius:4,position:"relative",zIndex:1}},n.payload.target.name?`${n.payload.target.name}: `:"",n.payload.value," €"))));return k.createElement(Y,{width:"100%",height:400},k.createElement(E,{data:ae,node:s,link:r,...e}))},args:{...O($),data:ae,nodeWidth:16,nodePadding:14,height:500,width:960,sort:!1,margin:{top:20,left:20,right:20,bottom:20}}};var re,oe,se;L.parameters={...L.parameters,docs:{...(re=L.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
...
}`,...(se=(oe=L.parameters)==null?void 0:oe.docs)==null?void 0:se.source}}};var ie,le,ce;T.parameters={...T.parameters,docs:{...(ie=T.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: (args: Args) => {
    return <ResponsiveContainer width="100%" height={400}>
        <Sankey data={nodeLinkData} {...args} />
      </ResponsiveContainer>;
...
}`,...(ce=(le=T.parameters)==null?void 0:le.docs)==null?void 0:ce.source}}};var ue,de,he;V.parameters={...V.parameters,docs:{...(ue=V.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(he=(de=V.parameters)==null?void 0:de.docs)==null?void 0:he.source}}};const Nt=["API","Customized","CustomNodeAndLink"],qt=Object.freeze(Object.defineProperty({__proto__:null,API:L,CustomNodeAndLink:V,Customized:T,__namedExportsOrder:Nt,default:Et},Symbol.toStringTag,{value:"Module"}));export{L as A,qt as C};

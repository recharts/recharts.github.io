import{r as a,k as p,l as f}from"./iframe-BRu_qZg1.js";import{L as P,i as k}from"./Label-PVHJRfQa.js";import{L as T}from"./Layer-BK1KTr5e.js";import{D as V,p as E}from"./arrayEqualityCheck-BgwbYKtC.js";import{s as z}from"./resolveDefaultProps-ClDGSYA8.js";import{Z as B}from"./ZIndexLayer-C8D4smXi.js";import{i as N}from"./Text-CZ6mhO2l.js";import{r as q}from"./index-DYVbWT0W.js";const D=e=>{const t=Array.isArray(e.value)?e.value[e.value.length-1]:e.value;if(N(t))return t},L=a.createContext(void 0),m=L.Provider,x=a.createContext(void 0),H=x.Provider;function F(){return a.useContext(L)}function R(){return a.useContext(x)}function l({valueAccessor:e=D,...t}){const{dataKey:n,clockWise:o,id:r,textBreakAll:s,zIndex:g,...C}=t,_=F(),I=R(),c=_||I;return!c||!c.length?null:a.createElement(B,{zIndex:g??V.label},a.createElement(T,{className:"recharts-label-list"},c.map((i,u)=>{const w=p(n)?e(i,u):E(i.payload,n),A=p(r)?{}:{id:`${r}-${u}`};return a.createElement(P,{key:`label-${u}`,...z(i),...C,...A,fill:t.fill??i.fill,parentViewBox:i.parentViewBox,value:w,textBreakAll:s,viewBox:i.viewBox,index:u,zIndex:0})})))}l.displayName="LabelList";function h({label:e}){return e?e===!0?a.createElement(l,{key:"labelList-implicit"}):a.isValidElement(e)||k(e)?a.createElement(l,{key:"labelList-implicit",content:e}):typeof e=="object"?a.createElement(l,{key:"labelList-implicit",...e,type:String(e.type)}):null:null}try{l.displayName="LabelList",l.__docgenInfo={description:"",displayName:"LabelList",props:{valueAccessor:{defaultValue:{value:`(entry: LabelListEntry): RenderableText => {
...
Other graphical components will show the same value as the dataKey of the component by default.`,name:"dataKey",required:!1,type:{name:"string | number | ((obj: any) => any)"}},content:{defaultValue:null,description:`If set a React element, the option is the customized React element of rendering each label.

import{e as t}from"./iframe-B9GGDGS1.js";import{T as l}from"./Text-BfPYOH_N.js";import{S as s}from"./arrayEqualityCheck-COtCLy3x.js";import{R as o}from"./RechartsHookInspector-BWkI8hZR.js";const c={angle:{description:`Text rotation angle in degrees.
...
**Note:** This controls horizontal alignment only and does not affect RTL text behavior.`,control:{type:"select"},options:["end","inherit","middle","start"],table:{type:{summary:'"end" | "inherit" | "middle" | "start"'},category:"General",defaultValue:{summary:"start"}},defaultValue:"start"},verticalAnchor:{description:`Vertical text alignment relative to the y coordinate.

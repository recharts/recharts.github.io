import{a as r}from"./iframe-3mrIZkil.js";import{g as c}from"./utils-ePvtT4un.js";import{P as s}from"./PolarGrid-BRYgbwpZ.js";import{S as u}from"./isWellBehavedNumber-ZyDhg4rS.js";const l={angleAxisId:{table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"0"}},defaultValue:0},cx:{description:`The x-coordinate of center.
...
This is only used when rendered outside a chart context.`,control:{type:"number"},table:{type:{summary:"number"},category:"General"}},polarAngles:{description:"The array of every line grid's angle.",table:{type:{summary:"Array<number>"},category:"General"}},polarRadius:{description:"The array of every circle grid's radius.",table:{type:{summary:"Array<number>"},category:"General"}},radialLines:{description:`Whether to render the radial lines extending from the inner radius to the outer edge at each angle.
When false, only the circular or polygonal grid lines are rendered.`,control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},radiusAxisId:{table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"0"}},defaultValue:0},stroke:{description:'The stroke color. If "none", no line will be drawn.',control:{type:"color"},table:{type:{summary:"string"},category:"Style"}},strokeDasharray:{description:"The pattern of dashes and gaps used to paint the lines of the grid.",table:{type:{summary:"number | string"},category:"Style"}},strokeWidth:{description:"The width of the stroke.",table:{type:{summary:"number | string"},category:"Style"}},zIndex:{description:`Z-Index of this component and its children. The higher the value,
the more on top it will be rendered.
Components with higher zIndex will appear in front of components with lower zIndex.
If undefined or 0, the content is rendered in the default layer without portals.`,control:{type:"number"},table:{type:{summary:"number"},category:"General",defaultValue:{summary:"-100"}},defaultValue:-100}},h={argTypes:l,component:s},[t,n]=[500,500],e={name:"Simple",render:d=>r.createElement(u,{width:t,height:n,viewBox:{x:0,y:0,width:t,height:n}},r.createElement(s,{cx:250,cy:250,innerRadius:0,outerRadius:200,...d})),args:{...c(l),polarAngles:[0,30,60,90,145,180,200,270,300],polarRadius:[10,20,40,80],stroke:"#ccc",strokeWidth:1,fill:"none",fillOpacity:.2}},p=["API"];var a,o,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(i=(o=e.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const b=Object.freeze(Object.defineProperty({__proto__:null,API:e,__namedExportsOrder:p,default:h},Symbol.toStringTag,{value:"Module"}));export{e as A,b as C};

import{R as r}from"./iframe-W15_yS8y.js";import{g as c}from"./utils-ePvtT4un.js";import{P as i}from"./PolarGrid-DPRyzmGn.js";import{S as u}from"./isWellBehavedNumber-J_RQo-Gx.js";const l={angleAxisId:{table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"0"}},defaultValue:0},cx:{description:`The x-coordinate of center.
...
If undefined or 0, the content is rendered in the default layer without portals.`,control:{type:"number"},table:{type:{summary:"number"},category:"General",defaultValue:{summary:"-100"}},defaultValue:-100}},p={argTypes:l,component:i},[t,n]=[500,500],e={name:"Simple",render:d=>r.createElement(u,{width:t,height:n,viewBox:{x:0,y:0,width:t,height:n}},r.createElement(i,{cx:250,cy:250,innerRadius:0,outerRadius:200,...d})),args:{...c(l),polarAngles:[0,30,60,90,145,180,200,270,300],polarRadius:[10,20,40,80],stroke:"#ccc",strokeWidth:1,fill:"none",fillOpacity:.2}};var a,o,s;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(s=(o=e.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const y=["API"],b=Object.freeze(Object.defineProperty({__proto__:null,API:e,__namedExportsOrder:y,default:p},Symbol.toStringTag,{value:"Module"}));export{e as A,b as C};

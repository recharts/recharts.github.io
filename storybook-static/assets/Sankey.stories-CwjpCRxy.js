import{s as we,r as m,l as xe,n as Le,t as Ne,e as f}from"./iframe-Ucw_npMd.js";import{g as O}from"./utils-ePvtT4un.js";import{m as Ve}from"./maxBy-CR0X1z-m.js";import{r as Te}from"./iteratee-B_1kyU97.js";import{V as Me,W as Ie,f as je,h as Pe,k as te,S as Re,p as N,u as ye,R as Y}from"./arrayEqualityCheck-C_bl4BTF.js";import{L as D}from"./Layer-BHKytU3r.js";import{R as De}from"./Rectangle-DdjFgehH.js";import{R as Ae,b as $e,J as We,T as Ge,i as qe}from"./RechartsWrapper-CwfOdweJ.js";import{t as pe,q as fe,p as ge}from"./hooks-D7V2KDBB.js";import{R as Xe,S as Fe}from"./RegisterGraphicalItemId-CbJhRY50.js";import{S as Oe}from"./chartDataContext-C8DSjEnl.js";import{r as Ye,b as z,a as ve}from"./resolveDefaultProps-BHeHZryb.js";import{T as ze}from"./Tooltip-DhN8fm3x.js";import{R as _}from"./RechartsHookInspector-Egzn0asm.js";var q={},ne;function _e(){return ne||(ne=1,function(e){Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});const t=Te();function i(o,n){if(!o||!o.length)return 0;n!=null&&(n=t.iteratee(n));let s;for(let a=0;a<o.length;a++){const c=n?n(o[a]):o[a];c!==void 0&&(s===void 0?s=c:s+=c)}return s}e.sumBy=i}(q)),q}var X,ae;function Be(){return ae||(ae=1,X=_e().sumBy),X}var Ke=Be();const Ue=we(Ke),He=(e,t)=>{const i=+e,o=t-i;return n=>i+o*n},L=e=>e.y+e.dy/2,I=e=>e&&e.value||0,P=(e,t)=>t.reduce((i,o)=>i+I(e[o]),0),Je=(e,t,i)=>i.reduce((o,n)=>{const s=t[n];if(s==null)return o;const a=e[s.source];return a==null?o:o+L(a)*I(t[n])},0),Qe=(e,t,i)=>i.reduce((o,n)=>{const s=t[n];if(s==null)return o;const a=e[s.target];return a==null?o:o+L(a)*I(t[n])},0),Ze=(e,t)=>e.y-t.y,et=(e,t)=>{const i=[],o=[],n=[],s=[];for(let a=0,c=e.length;a<c;a++){const r=e[a];(r==null?void 0:r.source)===t&&(n.push(r.target),s.push(a)),(r==null?void 0:r.target)===t&&(i.push(r.source),o.push(a))}return{sourceNodes:i,sourceLinks:o,targetLinks:s,targetNodes:n}},ke=(e,t)=>{const{targetNodes:i}=t;for(let o=0,n=i.length;o<n;o++){const s=i[o];if(s==null)continue;const a=e[s];a&&(a.depth=Math.max(t.depth+1,a.depth),ke(e,a))}},tt=({nodes:e,links:t},i,o,n)=>{var c;const s=e.map((r,u)=>{const l=et(t,u);return{...r,...l,value:Math.max(P(t,l.sourceLinks),P(t,l.targetLinks)),depth:0}});for(let r=0,u=s.length;r<u;r++){const l=s[r];l!=null&&!l.sourceNodes.length&&ke(s,l)}const a=((c=Ve(s,r=>r.depth))==null?void 0:c.depth)??0;if(a>=1){const r=(i-o)/a;for(let u=0,l=s.length;u<l;u++){const d=s[u];d!=null&&(d.targetNodes.length||n==="justify"&&(d.depth=a),d.x=d.depth*r,d.dx=o)}}return{tree:s,maxDepth:a}},nt=e=>{var i;const t=[];for(let o=0,n=e.length;o<n;o++){const s=e[o];s!=null&&(t[s.depth]||(t[s.depth]=[]),(i=t[s.depth])==null||i.push(s))}return t},at=(e,t,i,o,n)=>{let s=Math.min(...e.map(a=>{const c=Ue(a,I);return c===0?1/0:(t-(a.length-1)*i)/c}));s===1/0&&(s=0);for(let a=0,c=e.length;a<c;a++){const r=e[a];if(r!=null)if(n==="top"){let u=0;for(let l=0,d=r.length;l<d;l++){const h=r[l];h!=null&&(h.dy=h.value*s,h.y=u,u+=h.dy+i)}}else for(let u=0,l=r.length;u<l;u++){const d=r[u];d!=null&&(d.y=u,d.dy=d.value*s)}}return o.map(a=>({...a,dy:I(a)*s}))},F=(e,t,i,o=!0)=>{for(let n=0,s=e.length;n<s;n++){const a=e[n];if(a==null)continue;const c=a.length;o&&a.sort(Ze);let r=0;for(let u=0;u<c;u++){const l=a[u];if(l==null)continue;const d=r-l.y;d>0&&(l.y+=d),r=l.y+l.dy+i}r=t+i;for(let u=c-1;u>=0;u--){const l=a[u];if(l==null)continue;const d=l.y+l.dy+i-r;if(d>0)l.y-=d,r=l.y;else break}}},ot=(e,t,i,o)=>{for(let n=0,s=t.length;n<s;n++){const a=t[n];if(a!=null)for(let c=0,r=a.length;c<r;c++){const u=a[c];if(u!=null&&u.sourceLinks.length){const l=P(i,u.sourceLinks),d=Je(e,i,u.sourceLinks),h=l===0?L(u):d/l;u.y+=(h-L(u))*o}}}},rt=(e,t,i,o)=>{for(let n=t.length-1;n>=0;n--){const s=t[n];if(s!=null)for(let a=0,c=s.length;a<c;a++){const r=s[a];if(r!=null&&r.targetLinks.length){const u=P(i,r.targetLinks),l=Qe(e,i,r.targetLinks),d=u===0?L(r):l/u;r.y+=(d-L(r))*o}}}},st=(e,t)=>{for(let i=0,o=e.length;i<o;i++){const n=e[i];if(n==null)continue;let s=0,a=0;n.targetLinks.sort((c,r)=>{var k,g,v,E;const u=(k=t[c])==null?void 0:k.target,l=(g=t[r])==null?void 0:g.target;if(u==null||l==null)return 0;const d=(v=e[u])==null?void 0:v.y,h=(E=e[l])==null?void 0:E.y;return d==null||h==null?0:d-h}),n.sourceLinks.sort((c,r)=>{var k,g,v,E;const u=(k=t[c])==null?void 0:k.source,l=(g=t[r])==null?void 0:g.source;if(u==null||l==null)return 0;const d=(v=e[u])==null?void 0:v.y,h=(E=e[l])==null?void 0:E.y;return d==null||h==null?0:d-h});for(let c=0,r=n.targetLinks.length;c<r;c++){const u=n.targetLinks[c];if(u==null)continue;const l=t[u];l&&(l.sy=s,s+=l.dy)}for(let c=0,r=n.sourceLinks.length;c<r;c++){const u=n.sourceLinks[c];if(u==null)continue;const l=t[u];l&&(l.ty=a,a+=l.dy)}}},it=({data:e,width:t,height:i,iterations:o,nodeWidth:n,nodePadding:s,sort:a,verticalAlign:c,align:r})=>{const{links:u}=e,{tree:l}=tt(e,t,n,r),d=nt(l),h=at(d,i,s,u,c);if(F(d,i,s,a),c==="justify"){let g=1;for(let v=1;v<=o;v++)rt(l,d,h,g*=.99),F(d,i,s,a),ot(l,d,h,g),F(d,i,s,a)}return st(l,h),{nodes:l,links:h}},lt=e=>({x:+e.x+ +e.width/2,y:+e.y+ +e.height/2}),ut=e=>"sourceX"in e?{x:(e.sourceX+e.targetX)/2,y:(e.sourceY+e.targetY)/2}:void 0,ct=(e,t,i)=>{const{payload:o}=e;if(t==="node")return{payload:o,name:N(o,i,""),value:N(o,"value")};if("source"in o&&o.source&&o.target){const n=N(o.source,i,""),s=N(o.target,i,"");return{payload:o,name:`${n} - ${s}`,value:N(o,"value")}}},dt=(e,t,i,o)=>{if(t==null||typeof t!="string"||i==null||typeof i!="object")return;const n=t.split("-"),[s,a]=n,c=xe(i,`${s}s[${a}]`);if(c)return ct(c,s,o)},ht={chartName:"Sankey",defaultTooltipEventType:"item",validateTooltipEventTypes:["item"],tooltipPayloadSearcher:dt,eventEmitter:void 0},mt=m.memo(({dataKey:e,nameKey:t,stroke:i,strokeWidth:o,fill:n,name:s,data:a,id:c})=>{const r={dataDefinedOnItem:a,getPosition:Le,settings:{stroke:i,strokeWidth:o,fill:n,dataKey:e,name:s,nameKey:t,hide:!1,type:void 0,color:n,unit:"",graphicalItemId:c}};return m.createElement(Fe,{tooltipEntrySettings:r})});function yt(e,t){if(m.isValidElement(e))return m.cloneElement(e,t);if(typeof e=="function")return e(t);const{sourceX:i,sourceY:o,sourceControlX:n,targetX:s,targetY:a,targetControlX:c,linkWidth:r,...u}=t;return m.createElement("path",{className:"recharts-sankey-link",d:`
          M${i},${o}
          C${n},${o} ${c},${a} ${s},${a}
        `,fill:"none",stroke:"#333",strokeWidth:r,strokeOpacity:"0.2",...z(u)})}const pt=({link:e,nodes:t,left:i,top:o,i:n,linkContent:s,linkCurvature:a})=>{const{sy:c,ty:r,dy:u}=e,l=t[e.source],d=t[e.target];if(l==null||d==null)return;const h=l.x+l.dx+i,k=d.x+i,g=He(h,k),v=g(a),E=g(1-a),j=l.y+c+u/2+o,S=d.y+r+u/2+o;return{sourceX:h,targetX:k,sourceY:j,targetY:S,sourceControlX:v,targetControlX:E,sourceRelativeY:c,targetRelativeY:r,linkWidth:u,index:n,payload:{...e,source:l,target:d},...ve(s)}};function ft({graphicalItemId:e,props:t,i,linkContent:o,onMouseEnter:n,onMouseLeave:s,onClick:a,dataKey:c}){const r=ut(t),u=`link-${i}`,l=ye(),d={onMouseEnter:h=>{l(ge({activeIndex:u,activeDataKey:c,activeCoordinate:r,activeGraphicalItemId:e})),n(t,h)},onMouseLeave:h=>{l(fe()),s(t,h)},onClick:h=>{l(pe({activeIndex:u,activeDataKey:c,activeCoordinate:r,activeGraphicalItemId:e})),a(t,h)}};return m.createElement(D,{...d},yt(o,t))}function gt({graphicalItemId:e,modifiedLinks:t,links:i,linkContent:o,onMouseEnter:n,onMouseLeave:s,onClick:a,dataKey:c}){return m.createElement(D,{className:"recharts-sankey-links",key:"recharts-sankey-links"},i.map((r,u)=>{const l=t[u];return l==null?null:m.createElement(ft,{graphicalItemId:e,key:`link-${r.source}-${r.target}-${r.value}`,props:l,linkContent:o,i:u,onMouseEnter:n,onMouseLeave:s,onClick:a,dataKey:c})}))}function vt(e,t){return m.isValidElement(e)?m.cloneElement(e,t):typeof e=="function"?e(t):m.createElement(De,{className:"recharts-sankey-node",fill:"#0088fe",fillOpacity:"0.8",...z(t)})}const kt=({node:e,nodeContent:t,top:i,left:o,i:n})=>{const{x:s,y:a,dx:c,dy:r}=e;return{...ve(t),x:s+o,y:a+i,width:c,height:r,index:n,payload:e}};function bt({graphicalItemId:e,props:t,nodeContent:i,i:o,onMouseEnter:n,onMouseLeave:s,onClick:a,dataKey:c}){const r=ye(),u=lt(t),l=`node-${o}`,d={onMouseEnter:h=>{r(ge({activeIndex:l,activeDataKey:c,activeCoordinate:u,activeGraphicalItemId:e})),n(t,h)},onMouseLeave:h=>{r(fe()),s(t,h)},onClick:h=>{r(pe({activeIndex:l,activeDataKey:c,activeCoordinate:u,activeGraphicalItemId:e})),a(t,h)}};return m.createElement(D,{...d},vt(i,t))}function Et({graphicalItemId:e,modifiedNodes:t,nodeContent:i,onMouseEnter:o,onMouseLeave:n,onClick:s,dataKey:a}){return m.createElement(D,{className:"recharts-sankey-nodes",key:"recharts-sankey-nodes"},t.map((c,r)=>m.createElement(bt,{graphicalItemId:e,key:`node-${c.index}-${c.x}-${c.y}`,props:c,nodeContent:i,i:r,onMouseEnter:o,onMouseLeave:n,onClick:s,dataKey:a})))}const St={align:"justify",dataKey:"value",iterations:32,linkCurvature:.5,margin:{top:5,right:5,bottom:5,left:5},nameKey:"name",nodePadding:10,nodeWidth:10,sort:!0,verticalAlign:"justify",...qe};function Ct(e){const{className:t,style:i,children:o,id:n,...s}=e,{link:a,dataKey:c,node:r,onMouseEnter:u,onMouseLeave:l,onClick:d,data:h,iterations:k,nodeWidth:g,nodePadding:v,sort:E,linkCurvature:j,margin:S,verticalAlign:$,align:B}=e,be=z(s),w=je(),x=Pe(),{links:Ee,modifiedLinks:K,modifiedNodes:U}=m.useMemo(()=>{if(!h||!w||!x||w<=0||x<=0)return{nodes:[],links:[],modifiedLinks:[],modifiedNodes:[]};const y=w-(S.left??0)-(S.right??0),p=x-(S.top??0)-(S.bottom??0),b=it({data:h,width:y,height:p,iterations:k,nodeWidth:g,nodePadding:v,sort:E,verticalAlign:$,align:B}),Z=S.top||0,ee=S.left||0,Se=b.links.map((W,G)=>pt({link:W,nodes:b.nodes,i:G,top:Z,left:ee,linkContent:a,linkCurvature:j})).filter(Ne),Ce=b.nodes.map((W,G)=>kt({node:W,nodeContent:r,i:G,top:Z,left:ee}));return{nodes:b.nodes,links:b.links,modifiedLinks:Se,modifiedNodes:Ce}},[h,w,x,S,k,g,v,E,a,r,j,B,$]),H=m.useCallback((y,p,b)=>{u&&u(y,p,b)},[u]),J=m.useCallback((y,p,b)=>{l&&l(y,p,b)},[l]),Q=m.useCallback((y,p,b)=>{d&&d(y,p,b)},[d]);return!te(w)||!te(x)||!h||!h.links||!h.nodes?null:m.createElement(m.Fragment,null,m.createElement(Oe,{computedData:{links:K,nodes:U}}),m.createElement(Re,{...be,width:w,height:x},o,m.createElement(gt,{graphicalItemId:n,links:Ee,modifiedLinks:K,linkContent:a,dataKey:c,onMouseEnter:(y,p)=>H(y,"link",p),onMouseLeave:(y,p)=>J(y,"link",p),onClick:(y,p)=>Q(y,"link",p)}),m.createElement(Et,{graphicalItemId:n,modifiedNodes:U,nodeContent:r,dataKey:c,onMouseEnter:(y,p)=>H(y,"node",p),onMouseLeave:(y,p)=>J(y,"node",p),onClick:(y,p)=>Q(y,"node",p)})))}function C(e){const t=Ye(e,St),{width:i,height:o,style:n,className:s,id:a,throttleDelay:c,throttledEvents:r}=t,[u,l]=m.useState(null);return m.createElement(Ae,{preloadedState:{options:ht},reduxStoreName:s??"Sankey"},m.createElement(Me,{width:i,height:o}),m.createElement(Ie,{margin:t.margin}),m.createElement($e,{throttleDelay:c,throttledEvents:r}),m.createElement(We,{className:s,style:n,width:i,height:o,responsive:!1,ref:d=>{d&&!u&&l(d)},onMouseEnter:void 0,onMouseLeave:void 0,onClick:void 0,onMouseMove:void 0,onMouseDown:void 0,onMouseUp:void 0,onContextMenu:void 0,onDoubleClick:void 0,onTouchStart:void 0,onTouchMove:void 0,onTouchEnd:void 0},m.createElement(Ge.Provider,{value:u},m.createElement(Xe,{id:a,type:"sankey"},d=>m.createElement(m.Fragment,null,m.createElement(mt,{dataKey:t.dataKey,nameKey:t.nameKey,stroke:t.stroke,strokeWidth:t.strokeWidth,fill:t.fill,name:t.name,data:t.data,id:d}),m.createElement(Ct,{...t,id:d}))))))}C.displayName="Sankey";try{C.displayName="Sankey",C.__docgenInfo={description:`Flow diagram in which the width of the arrows is proportional to the flow rate.
...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},wt={argTypes:A,component:C},V={name:"Simple",render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:R,...e},f.createElement(ze,null),f.createElement(_,null))),args:{...O(A),data:R}},T={render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:R,...e},f.createElement(_,null))),args:{...O(A),data:R,nodeWidth:10,nodePadding:60,height:500,width:960}},M={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],i=n=>f.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),o=n=>f.createElement("g",null,f.createElement("path",{d:`
  M${n.sourceX},${n.sourceY}
  C${n.sourceControlX},${n.sourceY} ${n.targetControlX},${n.targetY} ${n.targetX},${n.targetY}`,fill:"none",stroke:t[n.payload.source.depth%t.length],strokeOpacity:.4,strokeWidth:n.linkWidth,strokeLinecap:"butt"}),f.createElement("foreignObject",{x:n.sourceX,y:n.targetY-n.linkWidth/2,width:Math.max(n.targetX,n.sourceX)-Math.min(n.targetX,n.sourceX),height:n.linkWidth,style:{overflow:"visible"}},f.createElement("div",{style:{boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"flex-end",width:"100%",height:"100%",overflow:"visible",padding:"0.5em",gap:8}},f.createElement("div",{style:{fontSize:10,fontFamily:"sans-serif",textAlign:"center",backgroundColor:"#f1f5fe80",padding:"0.25em 0.5em",borderRadius:4,position:"relative",zIndex:1}},n.payload.target.name?`${n.payload.target.name}: `:"",n.payload.value," €"))));return f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:oe,node:i,link:o,...e},f.createElement(_,null)))},args:{...O(A),data:oe,nodeWidth:16,nodePadding:14,height:500,width:960,sort:!1,margin:{top:20,left:20,right:20,bottom:20}}};var re,se,ie;V.parameters={...V.parameters,docs:{...(re=V.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
...
}`,...(ie=(se=V.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var le,ue,ce;T.parameters={...T.parameters,docs:{...(le=T.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: (args: Args) => {
    return <ResponsiveContainer width="100%" height={400}>
        <Sankey data={nodeLinkData} {...args}>
          <RechartsHookInspector />
...
}`,...(ce=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:ce.source}}};var de,he,me;M.parameters={...M.parameters,docs:{...(de=M.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(me=(he=M.parameters)==null?void 0:he.docs)==null?void 0:me.source}}};const xt=["API","Customized","CustomNodeAndLink"],qt=Object.freeze(Object.defineProperty({__proto__:null,API:V,CustomNodeAndLink:M,Customized:T,__namedExportsOrder:xt,default:wt},Symbol.toStringTag,{value:"Module"}));export{V as A,qt as C};

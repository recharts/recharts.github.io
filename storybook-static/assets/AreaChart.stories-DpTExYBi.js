...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},G={argTypes:s,component:n},a={name:"Simple",render:t=>e.createElement(l,{width:"100%",height:400},e.createElement(n,{...t,margin:{top:0,bottom:0,left:50,right:50}},e.createElement(c,{dataKey:"pv",strokeWidth:3,stroke:"#2451B7",fill:"#5376C4"}),e.createElement(w,{opacity:.1,vertical:!1}),e.createElement(A,null),e.createElement(m,null))),args:{...i(s),data:v,margin:{top:0,bottom:0,left:50,right:50}}},E=x.tension(.5),r={render:t=>e.createElement(l,{width:"100%",height:400},e.createElement(n,{...t},e.createElement(c,{type:E,dataKey:"pv",stroke:"#ff7300",fill:"#ff7300",fillOpacity:.9}),e.createElement(m,null))),args:{...i(s),data:v,layout:"horizontal",margin:{top:0,bottom:0,left:50,right:50}}},o={render:t=>e.createElement(l,{width:"100%",height:400},e.createElement(n,{...t},e.createElement(c,{dataKey:"A",stroke:"green",fill:"green",fillOpacity:.5}),e.createElement(z,{dataKey:"subject",type:"category",allowDuplicatedCategory:!1}),e.createElement(A,null),e.createElement(m,null))),args:{...i(s),data:T,layout:"horizontal",margin:{top:0,bottom:0,left:50,right:50}}};var u,h,p;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
...
}`,...(p=(h=a.parameters)==null?void 0:h.docs)==null?void 0:p.source}}};var y,d,g;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: (args: Args) => {
    return <ResponsiveContainer width="100%" height={400}>
        <AreaChart {...args}>
...
}`,...(g=(d=r.parameters)==null?void 0:d.docs)==null?void 0:g.source}}};var f,b,C;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: (args: Args) => {
    return <ResponsiveContainer width="100%" height={400}>
        <AreaChart {...args}>
...
}`,...(C=(b=o.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};const k=["API","CustomType","CategoricalAreaChart"],_=Object.freeze(Object.defineProperty({__proto__:null,API:a,CategoricalAreaChart:o,CustomType:r,__namedExportsOrder:k,default:G},Symbol.toStringTag,{value:"Module"}));export{a as A,_ as C};

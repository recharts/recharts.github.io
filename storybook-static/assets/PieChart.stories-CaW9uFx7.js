...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},F={argTypes:c,component:u},n={name:"Simple",render:t=>{const{data:i,activeShape:s}=t;return e.createElement(k,{width:"100%",height:400},e.createElement(u,{...t},e.createElement(p,{data:i,dataKey:"uv",shape:({isActive:m,...l})=>e.createElement(P,{...l,fill:m?s.fill:l.fill})}),e.createElement(A,{defaultIndex:3})))},args:{...y(c),data:D,activeShape:{fill:"red"},margin:{top:0,right:0,bottom:0,left:0}}},r={render:t=>e.createElement(u,{...t},e.createElement(p,{data:t.data,dataKey:"uv",nameKey:"name",innerRadius:50,outerRadius:80,cornerRadius:8},e.createElement(v,{position:"center",fill:"#000",fontSize:12,fontWeight:"bold",dy:-7},"Donut"),e.createElement(v,{position:"center",fontSize:12,fontWeight:"bold",dy:8},"Chart"),e.createElement(M,{align:"right",verticalAlign:"middle",layout:"vertical"}))),args:{...y(c),width:500,height:300,data:D}},o={render:t=>{const i=[{x:{value:1},name:"x1",fill:"blue"},{x:{value:2},name:"x2",fill:"red"},{x:{value:3},name:"x3",fill:"green"}],s=[{y:{value:3},name:"y1",fill:"blue"},{y:{value:2},name:"y2",fill:"red"},{y:{value:1},name:"y3",fill:"green"}],m=a=>(f(a.x),a.x.value),l=a=>(f(a.y),a.y.value),[d,g]=b.useState(!1),[z,h]=b.useState(!0);return e.createElement(e.Fragment,null,e.createElement("button",{type:"button",onClick:()=>{g(!1),h(!0)}},"Use data1"),e.createElement("button",{type:"button",onClick:()=>{g(!0),h(!0)}},"Use data2"),e.createElement("button",{type:"button",onClick:()=>{h(!1)}},"Hide"),e.createElement(u,{...t,data:d?s:i},e.createElement(A,null),e.createElement(M,null),e.createElement(p,{data:d?s:i,name:"Animated line",hide:!z,type:"monotone",dataKey:d?l:m,stroke:"#8884d8",strokeDasharray:"5 5",label:{fill:"red"},animationDuration:3e3})))},args:{...y(c),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}},K=["API","Donut","ChangingDataKey"];var E,C,G;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(G=(C=n.parameters)==null?void 0:C.docs)==null?void 0:G.source}}};var S,x,V;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
...
}`,...(V=(x=r.parameters)==null?void 0:x.docs)==null?void 0:V.source}}};var T,w,R;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
    type MockDataType = {
      x?: {
        value: number;
...
}`,...(R=(w=o.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};const B=Object.freeze(Object.defineProperty({__proto__:null,API:n,ChangingDataKey:o,Donut:r,__namedExportsOrder:K,default:F},Symbol.toStringTag,{value:"Module"}));export{n as A,B as C};

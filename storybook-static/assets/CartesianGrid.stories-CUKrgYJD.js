import{a as e}from"./iframe-CNkb7Pxq.js";import{g as h}from"./utils-ePvtT4un.js";import{C as i}from"./CartesianGrid-Ck43GCkE.js";import{R as p}from"./zIndexSlice-wl2-d2L7.js";import{C as m}from"./ComposedChart-C_D-eBru.js";import{p as g}from"./Page-Cj8EiXz7.js";import{X as b}from"./XAxis-Cy627mpO.js";import{Y as v}from"./YAxis-Bv4i31q_.js";const n={fill:{description:"The background color used to fill the space between grid lines",control:{type:"color"},table:{type:{summary:"string"},category:"Style"}},fillOpacity:{description:"The opacity of the background used to fill the space between grid lines",table:{type:{summary:"number | string"},category:"General"}},height:{description:"The height of grid. If undefined, covers the full height of the chart plot area.",table:{type:{summary:"number | string"},category:"General"}},horizontal:{description:"If set false, no horizontal grid lines will be drawn.",table:{type:{summary:"(union of 5 variants)"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},horizontalCoordinatesGenerator:{description:"A function that generates the y-coordinates of all horizontal lines.",table:{type:{summary:"HorizontalCoordinatesGenerator"},category:"General"}},horizontalFill:{description:`Defines background color of stripes.
...
If left undefined, it will be computed from the chart's offset and margins.`,table:{type:{summary:"number | string"},category:"General"}},yAxisId:{description:"The id of YAxis which is corresponding to the data. Required when there are multiple YAxes.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"0"}},defaultValue:0},zIndex:{control:{type:"number"},table:{type:{summary:"number"},category:"General",defaultValue:{summary:"-100"}},defaultValue:-100}},w={component:i,argTypes:n,args:{horizontal:!0,vertical:!0}},r={render:a=>{const[f,o]=[500,500];return e.createElement(p,{width:"100%",height:o},e.createElement(m,{width:f,height:o},e.createElement(i,{...a})))},args:{...h(n),y:0,x:0,width:500,height:500,fillOpacity:.4,horizontalPoints:[10,20,30,100,400],verticalPoints:[100,200,300,400],verticalFill:["red","#eee"],horizontalFill:["#eee","yellow"],strokeDasharray:"10 10"}},t={render:a=>e.createElement(p,{width:"100%",height:500},e.createElement(m,{width:500,height:500,data:g},e.createElement(b,{dataKey:"name"}),e.createElement(v,{dataKey:"pv"}),a.displayGridA&&e.createElement(i,{verticalFill:["#aaeeee","#eeeeaa"],stroke:"trasparent"}),a.displayGridB&&e.createElement(i,{stroke:"silver",strokeDasharray:"3 3",strokeWidth:3}))),args:{...h(n),displayGridA:!0,displayGridB:!0}},G=["API","MultipleGrids"];var s,l,d;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(y=(u=t.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};const I=Object.freeze(Object.defineProperty({__proto__:null,API:r,MultipleGrids:t,__namedExportsOrder:G,default:w},Symbol.toStringTag,{value:"Module"}));export{r as A,I as C};

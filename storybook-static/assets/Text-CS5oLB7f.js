...
- Requires \`width\` to be set for line breaking to occur`,name:"maxLines",required:!1,type:{name:"number"}}}}}catch{}try{W.displayName="Text",W.__docgenInfo={description:"",displayName:"Text",props:{textAnchor:{defaultValue:null,description:`Horizontal text alignment within the text element.
...
@defaultValue 'start'`,name:"textAnchor",required:!1,type:{name:"enum",value:[{value:'"end"'},{value:'"middle"'},{value:'"inherit"'},{value:'"start"'}]}},verticalAnchor:{defaultValue:null,description:`Vertical text alignment relative to the y coordinate.
...
**Interaction with other props:**
- When \`scaleToFit\` is true, this property is ignored
- Requires \`width\` to be set for line breaking to occur`,name:"maxLines",required:!1,type:{name:"number"}},angle:{defaultValue:null,description:`Text rotation angle in degrees.
Positive values rotate clockwise, negative values rotate counterclockwise.
@defaultValue 0`,name:"angle",required:!1,type:{name:"number"}},lineHeight:{defaultValue:null,description:`Line height for multi-line text.
...
@defaultValue '1em'`,name:"lineHeight",required:!1,type:{name:"string | number"}}}}}catch{}export{W as T,G as a,B as i};

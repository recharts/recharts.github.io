import{e}from"./iframe-BRu_qZg1.js";import{g as y}from"./utils-ePvtT4un.js";import{b}from"./Page-Cj8EiXz7.js";import{a as l,F as p}from"./FunnelChart-DbfhJTd3.js";import{R as E}from"./arrayEqualityCheck-BgwbYKtC.js";import{L as C}from"./ReactUtils-gnwCD4Om.js";import{T as g}from"./Tooltip-CmHJro1j.js";import{R as f}from"./RechartsHookInspector-CJy-wMRv.js";import{L as G}from"./Legend-BJ_ZIhKW.js";const s={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
bar will be calculated by the barCategoryGap, barGap and the quantity of bar groups.`,table:{type:{summary:"number | string"},category:"General"}},baseValue:{description:"The base value of area.",table:{type:{summary:'"dataMax" | "dataMin" | number'},category:"General"}},children:{table:{type:{summary:"ReactNode"},category:"General"}},className:{control:{type:"text"},table:{type:{summary:"string"},category:"Style"}},compact:{control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General"}},cursor:{description:'The CSS cursor style applied to the chart container.\nUseful for setting the mouse cursor when hovering over the chart (e.g. `"pointer"`, `"crosshair"`).',table:{type:{summary:"(union of 45 variants)"},category:"General"}},data:{description:`The source data. Each element should be an object.
...
}`,...(u=(c=r.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};var h,m,d;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(d=(m=n.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};const T=["API","WithChangingDataKey"],z=Object.freeze(Object.defineProperty({__proto__:null,API:r,WithChangingDataKey:n,__namedExportsOrder:T,default:S},Symbol.toStringTag,{value:"Module"}));export{r as A,z as C};
